...
def simple_query(request):
    ...
    if param:
        lodgments=Couch.actives.filter(Q(city__icontains=param) | Q(title__icontains=param) | Q(user__username__icontains=param)| Q(category__name__icontains=param))
    else:
        lodgments=Couch.actives.all()
